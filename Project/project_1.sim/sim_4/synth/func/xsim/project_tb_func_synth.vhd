...
-- Date        : Wed Jan 31 11:55:45 2024
-- Host        : ArmaPC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/armif/OneDrive/Desktop/project_1/project_1.sim/sim_4/synth/func/xsim/project_tb_func_synth.vhd
...
architecture STRUCTURE of project_reti_logiche is
  signal \FSM_sequential_curr_st_reg_n_0_[2]\ : STD_LOGIC;
  signal curr_st : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  signal \o_r0[15]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \o_r2[7]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \o_r3[7]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \o_r4[7]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \o_r5[7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_next_st[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_sequential_next_st[1]_i_1\ : label is "soft_lutpair0";
  attribute CCIO_EN : string;
  attribute CCIO_EN of i_clk_IBUF_inst : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[0]_inst\ : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[1]_inst\ : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[2]_inst\ : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[3]_inst\ : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[4]_inst\ : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[5]_inst\ : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[6]_inst\ : label is "TRUE";
  attribute CCIO_EN of \i_mem_data_IBUF[7]_inst\ : label is "TRUE";
  attribute CCIO_EN of i_rst_IBUF_inst : label is "TRUE";
  attribute CCIO_EN of i_start_IBUF_inst : label is "TRUE";
  attribute CCIO_EN of i_w_IBUF_inst : label is "TRUE";
begin
...
o_done_reg: unisim.vcomponents.FDRE
    generic map(
      ...
      C => i_clk_IBUF_BUFG,
      CE => \o_z0[7]_i_2_n_0\,
      D => \FSM_sequential_curr_st_reg_n_0_[2]\,
      Q => o_done_OBUF,
      R => '0'
    );
...
o_mem_en_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
o_mem_en_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\o_z0[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"83"
    )
        port map (
